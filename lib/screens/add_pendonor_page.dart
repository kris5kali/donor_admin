...
class AddPendonorPage extends StatefulWidget {
  @override
  _AddPendonorPageState createState() => _AddPendonorPageState();
}

class _AddPendonorPageState extends State<AddPendonorPage> {
  String _email;
  String _password;
  String _nama;
